...
scrna_myeloid = subset(scrna_myeloid, idents= ("Ependymoma"))
...
write_rds(scrna_myeloid, paste0(wd, "TME_B7H3/Seurat_subsets/scrna_immune_myeloid_ep.rds"))

###Lymphoid
wd = "/hpc/pmc_kool/fvalzano/Rstudio_Test1/TME/TME_files_March24/"
scrna_lymphoid = read_rds(paste0(wd,"Seurat_subsets/Post_Annotation/scrna_immune_lymphoid.rds"))
Idents(scrna_lymphoid) = "Entity"
scrna_lymphoid = subset(scrna_lymphoid, idents= ("Ependymoma"))
...
write_rds(scrna_lymphoid, paste0(wd, "TME_B7H3/Seurat_subsets/scrna_immune_lymphoid_ep.rds"))
