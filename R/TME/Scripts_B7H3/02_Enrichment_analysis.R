...
###Myeloid
wd="/hpc/pmc_kool/fvalzano/Rstudio_Test1/TME/TME_files_March24/TME_B7H3/"
scrna_myeloid = readRDS(paste0(wd, "Seurat_subsets/Post_Annotation/scrna_immune_myeloid_ep.rds"))
...
###Lymphoid
wd="/hpc/pmc_kool/fvalzano/Rstudio_Test1/TME/TME_files_March24/TME_B7H3/"
scrna_lymphoid = readRDS(paste0(wd, "Seurat_subsets/Post_Annotation/scrna_immune_lymphoid_ep.rds"))
