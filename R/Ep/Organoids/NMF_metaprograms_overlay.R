...
NMF_meta = read_xlsx("/hpc/pmc_kool/fvalzano/Rstudio_Test1/Ependymoma_organoids/NMFmetaprorams_from_Filbin/media-5-2.xlsx")
...
pdf("/hpc/pmc_kool/fvalzano/Rstudio_Test1/Ependymoma_organoids/Plots/Overlay_meta_unbiased_clustering.pdf", width = 10, height = 7.5)
DimPlot(scrna,
...
dev.off()
pdf("/hpc/pmc_kool/fvalzano/Rstudio_Test1/Ependymoma_organoids/Plots/Overlay_meta_ownmapping.pdf", width = 10, height = 7.5)
DimPlot(scrna,
