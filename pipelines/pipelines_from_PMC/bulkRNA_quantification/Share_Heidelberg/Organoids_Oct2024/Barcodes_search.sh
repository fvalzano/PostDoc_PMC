...
for sample_dir in ${dir}/${fq_dir}/*; do
    ...
    if [ -d "${sample_dir}" ]; then
        ...
        if [ -n "${r1_fastq}" ]; then
            ...
            mkdir -p /hpc/pmc_kool/fvalzano/wdl_pipeline_v12.1.0/wdl/inputs/barcodes/Share_Heidelberg/Oct2024/
            # Move the barcode file to the designated directory
            scp barcodes_${sample} /hpc/pmc_kool/fvalzano/wdl_pipeline_v12.1.0/wdl/inputs/barcodes/Share_Heidelberg/Oct2024/
